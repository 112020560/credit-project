# Spec: Member Enrollment

Enrolamiento explícito de un cliente existente como socio cooperativo. El CreditSystem es el único dueño del número de socio y del agregado `CooperativeMember`. El enrolamiento es un acto deliberado de un operador, separado de la creación del cliente en el CRM.
