# Spec: Member Number Generation

Generación atómica y configurable de números de socio cooperativo. El formato por defecto es `{Prefix}-{año}-{secuencial con padding}` (ej. `CM-2026-00143`). La secuencia es por año, se reinicia cada año y garantiza unicidad bajo concurrencia mediante una operación SQL atómica.
