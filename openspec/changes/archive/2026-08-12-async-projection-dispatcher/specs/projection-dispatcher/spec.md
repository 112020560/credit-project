...
5. Si el proyector falla: ejecute la política de reintentos (ver Requirement: Política de reintentos)
...
- **THEN** el worker ejecuta la política de reintentos (ver Requirement: Política de reintentos)
